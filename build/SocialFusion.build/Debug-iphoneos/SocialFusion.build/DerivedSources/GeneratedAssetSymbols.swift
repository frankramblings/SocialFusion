...
extension ColorResource {
    ...
    static let primary = ColorResource(name: "PrimaryColor", bundle: resourceBundle)

    /// The "SecondaryColor" asset catalog color resource.
    static let secondary = ColorResource(name: "SecondaryColor", bundle: resourceBundle)
...
extension ImageResource {
    ...
    static let blueskyLogo = ImageResource(name: "BlueskyLogo", bundle: resourceBundle)

    /// The "MastodonLogo" asset catalog image resource.
    static let mastodonLogo = ImageResource(name: "MastodonLogo", bundle: resourceBundle)
