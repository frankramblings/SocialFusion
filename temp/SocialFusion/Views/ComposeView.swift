...
struct ComposeView: View {
    ...
    init() {
        ...
        _selectedVisibility = State(initialValue: UserDefaults.standard.integer(forKey: "defaultPostVisibility"))
    }
            ...
            VStack {
                ...
                Button("Add Sample Image") {
                    ...
                    if selectedImages.count < maxImages {
                        ...
                        let placeholderImage = UIImage(systemName: "photo")?.withTintColor(.gray, renderingMode: .alwaysOriginal) ?? UIImage()
